...
string_columns = ["request", "response"]
...
# Ensure feedback_df has the correct column for join and includes 'feedback' column
feedback_df = feedback_df.withColumnRenamed("feedback_response", "feedback")
