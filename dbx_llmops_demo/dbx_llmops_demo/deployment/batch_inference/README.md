# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [dbx_llmops_demo/resources/README.md](../../resources/README.md)
...
df.write.mode("overwrite").saveAsTable(
    name="<catalog>.llmops.feature_store_inference_input"
)
```
