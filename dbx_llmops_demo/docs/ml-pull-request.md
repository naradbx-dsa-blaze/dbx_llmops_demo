...
Opening a pull request will trigger a[workflow](../.github/workflows/dbx_llmops_demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/staging/dbx_llmops_demo/dbx_llmops_demo-model)
* [Prod model in UC](https://e2-demo-field-eng.cloud.databricks.com/explore/data/models/prod/dbx_llmops_demo/dbx_llmops_demo-model)
. 
