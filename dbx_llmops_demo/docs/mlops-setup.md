...
git add README.md docs .gitignore dbx_llmops_demo/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[dbx_llmops_demo/databricks.yml](../dbx_llmops_demo/databricks.yml) file.
...
Follow the instructions in [dbx_llmops_demo/resources/README.md](../dbx_llmops_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../dbx_llmops_demo/resources/README.md)  to propose, test, and deploy
